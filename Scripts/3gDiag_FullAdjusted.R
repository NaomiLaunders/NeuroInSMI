#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Fully adjusted results - schizophrenia, bipolar and other psychoses vs control - adjusting for AGE, SEX, ETHNICITY, REGION, CALENDAR YEAR, BMI, SMOKING, ALCOHOL, DRUG USE
# 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
write.csv(b5, file = "/Neuro/Outputs/AdjDiagB5.csv")


####Fully Adjusted, diag, in -3####
...
write.csv(b3, file = "/Neuro/Outputs/AdjDiagB3.csv")


####Fully Adjusted, diag, in -1####
...
write.csv(b1, file = "/Neuro/Outputs/AdjDiagB1.csv")


####Fully Adjusted, diag, at index - NOTE renamed index b0 as b1 used above for -1 year####
...
write.csv(b0, file = "/Neuro/Outputs/AdjDiagB0.csv")
...
write.csv(a1, file = "/Neuro/Outputs/AdjDiagA1.csv")
...
write.csv(a3, file = "/Neuro/Outputs/AdjDiagA3.csv")
...
write.csv(a5, file = "/Neuro/Outputs/AdjDiagA5.csv")
...
save(Counts, file= "/Neuro/Data/AdjDiagResults.Rdata")
...
MS<-ggplot()+
  ...
  labs(y = "Adjusted odds ratio", title="Multiple sclerosis", x="Time before and after index date (years)")+
  scale_y_continuous(limits = c(0, 5), breaks=c(0.5, 1, seq(2, 5, by=1)))+   
  scale_x_continuous(limits = c(-5, 5), breaks=c(-5, -3, -1, 0, 1, 3, 5))

MS

#Save for poster
ggsave("/Neuro/PosterMS.tiff", plot=MS, device="tiff", dpi=300)
...
Cereb<-ggplot()+
  ...
  scale_color_manual(values = c("dodgerblue2", "firebrick2", "gold1" ))+
  theme(legend.position = c("bottom"),legend.title = element_blank(), legend.text = element_text(colour = "black", size = 16), axis.text.x=element_text(size=16, colour="black"), axis.title.x=element_text(size=16),axis.text.y=element_text(size=16, colour="black"), axis.title.y=element_text(size=16), axis.line=element_line(color="black", size = 0.8), axis.ticks=element_line(color="black", size = 0.8))+
  labs(y = "Adjusted odds ratio", title="Cerebrovascular disease", x="Time before and after index date (years)")+
...
#Save for poster
ggsave("/Neuro/PosterCereb.tiff", plot=Cereb, device="tiff", dpi=300)
...
Dem<-ggplot()+
  ...
  scale_color_manual(values = c("dodgerblue2", "firebrick2", "gold1" ))+
  theme(legend.position = c("bottom"),legend.title = element_blank(), legend.text = element_text(colour = "black", size = 16), axis.text.x=element_text(size=16, colour="black"), axis.title.x=element_text(size=16),axis.text.y=element_text(size=16, colour="black"), axis.title.y=element_text(size=16), axis.line=element_line(color="black", size = 0.8), axis.ticks=element_line(color="black", size = 0.8))+
  labs(y = "Adjusted odds ratio", title="Dementia", x="Time before and after index date (years)")+
  scale_y_continuous(limits = c(0.5, 7), breaks=c(0.5, 1, seq(2, 7, by=1)))+   
  scale_x_continuous(limits = c(-5, 5), breaks=c(-5, -3, -1, 0, 1, 3, 5))
Dem
#Save for poster
ggsave("/Neuro/PosterDem.tiff", plot=Dem, device="tiff", dpi=300)
...
ggplot()+
  ...
  scale_color_manual(values = c("dodgerblue2", "firebrick2", "gold1" ))+
  theme(legend.position = c("bottom"),legend.title = element_blank(), legend.text = element_text(colour = "black", size = 16), axis.text.x=element_text(size=16, colour="black"), axis.title.x=element_text(size=16),axis.text.y=element_text(size=16, colour="black"), axis.title.y=element_text(size=16), axis.line=element_line(color="black", size = 0.8), axis.ticks=element_line(color="black", size = 0.8))+
  labs(y = "Adjusted odds ratio", title="Ataxia", x="Time before and after index date (years)")+
  scale_y_continuous(limits = c(0.5, 5), breaks=c(0.5, 1, seq(2, 5, by=1)))+   
  scale_x_continuous(limits = c(-5, 5), breaks=c(-5, -3, -1, 0, 1, 3, 5))
...
Epi<-ggplot()+
  ...
  scale_color_manual(values = c("dodgerblue2", "firebrick2", "gold1" ))+
  theme(legend.position = c("bottom"),legend.title = element_blank(), legend.text = element_text(colour = "black", size = 16), axis.text.x=element_text(size=16, colour="black"), axis.title.x=element_text(size=16),axis.text.y=element_text(size=16, colour="black"), axis.title.y=element_text(size=16), axis.line=element_line(color="black", size = 0.8), axis.ticks=element_line(color="black", size = 0.8))+
  labs(y = "Adjusted odds ratio", title="Epilepsy", x="Time before and after index date (years)")+
  scale_y_continuous(limits = c(0.5, 5), breaks=c(0.5, 1, seq(2, 5, by=1)))+   
  scale_x_continuous(limits = c(-5, 5), breaks=c(-5, -3, -1, 0, 1, 3, 5))
...
#Save for poster
ggsave("/Neuro/PosterEpi.tiff", plot=Epi, device="tiff", dpi=300)
...
Park<-ggplot()+
  ...
  scale_color_manual(values = c("dodgerblue2", "firebrick2", "gold1" ))+
  theme(legend.position = c("bottom"),legend.title = element_blank(), legend.text = element_text(colour = "black", size = 16), axis.text.x=element_text(size=16, colour="black"), axis.title.x=element_text(size=16),axis.text.y=element_text(size=16, colour="black"), axis.title.y=element_text(size=16), axis.line=element_line(color="black", size = 0.8), axis.ticks=element_line(color="black", size = 0.8))+
  labs(y = "Adjusted odds ratio", title="Parkinson's disease", x="Time before and after index date (years)")+
  scale_y_continuous(limits = c(0.5, 7), breaks=c(0.5, 1, seq(2, 7, by=1)))+   
  scale_x_continuous(limits = c(-5, 5), breaks=c(-5, -3, -1, 0, 1, 3, 5))
...
#Save for poster
ggsave("/Neuro/PosterPark.tiff", plot=Park, device="tiff", dpi=300)
...
Para<-ggplot()+
  ...
  scale_color_manual(values = c("dodgerblue2", "firebrick2", "gold1" ))+
  theme(legend.position = c("bottom"),legend.title = element_blank(), legend.text = element_text(colour = "black", size = 16), axis.text.x=element_text(size=16, colour="black"), axis.title.x=element_text(size=16),axis.text.y=element_text(size=16, colour="black"), axis.title.y=element_text(size=16), axis.line=element_line(color="black", size = 0.8), axis.ticks=element_line(color="black", size = 0.8))+
  labs(y = "Adjusted odds ratio", title="Paralysis", x="Time before and after index date (years)")+
  scale_y_continuous(limits = c(0.5, 5), breaks=c(0.5, 1, seq(2, 5, by=1)))+   
  scale_x_continuous(limits = c(-5, 5), breaks=c(-5, -3, -1, 0, 1, 3, 5))
...
#Save for poster
ggsave("/Neuro/PosterPara.tiff", plot=Para, device="tiff", dpi=300)
...
CP<-ggplot()+
  ...
  scale_color_manual(values = c("dodgerblue2", "firebrick2", "gold1" ))+
  theme(legend.position = c("bottom"),legend.title = element_blank(), legend.text = element_text(colour = "black", size = 16), axis.text.x=element_text(size=16, colour="black"), axis.title.x=element_text(size=16),axis.text.y=element_text(size=16, colour="black"), axis.title.y=element_text(size=16), axis.line=element_line(color="black", size = 0.8), axis.ticks=element_line(color="black", size = 0.8))+
  labs(y = "Adjusted odds ratio", title="Cerebral Palsy", x="Time before and after index date (years)")+
  scale_y_continuous(limits = c(0.5, 7), breaks=c(0.5, 1, seq(2, 7, by=1)))+   
  scale_x_continuous(limits = c(-5, 5), breaks=c(-5, -3, -1, 0, 1, 3, 5))
...
#Save for poster
ggsave("/Neuro/PosterCP.tiff", plot=CP, device="tiff", dpi=300)
...
ggplot()+
  ...
  theme(axis.title.y=element_text(size=16))+
  theme(title=element_text(size=16))+
  scale_fill_manual(values = c("firebrick2", "gold1", "dodgerblue2"))+
  scale_color_manual(values = c("firebrick2", "gold1", "dodgerblue2"))+
  theme(legend.position = c("bottom"),legend.title = element_blank(), legend.text = element_text(colour = "black", size = 16), axis.text.x=element_text(size=16, colour="black"), axis.title.x=element_text(size=16),axis.text.y=element_text(size=16, colour="black"), axis.title.y=element_text(size=16), axis.line=element_line(color="black", size = 0.8), axis.ticks=element_line(color="black", size = 0.8))+
  labs(y = "Odds ratio", title="CSF disorders", x="Time before and after index date (years)")+
  scale_y_continuous(limits = c(0.5, 7), breaks=c(0.5, 1, seq(2, 7, by=1)))+   
  scale_x_continuous(limits = c(-5, 5), breaks=c(-5, -3, -1, 0, 1, 3, 5))
...
ggplot()+
  ...
  scale_color_manual(values = c("firebrick2", "gold1", "dodgerblue2"))+
  theme(legend.position = c("bottom"),legend.title = element_blank(), legend.text = element_text(colour = "black", size = 16), axis.text.x=element_text(size=16, colour="black"), axis.title.x=element_text(size=16),axis.text.y=element_text(size=16, colour="black"), axis.title.y=element_text(size=16), axis.line=element_line(color="black", size = 0.8), axis.ticks=element_line(color="black", size = 0.8))+
  labs( , y = "Odds ratio", title="Spinal cord disorders", x="Time before and after index date (years)")+
  scale_y_continuous(limits = c(0, 6), breaks=c(0.5, 1, seq(2, 5, by=1)))+   
  scale_x_continuous(limits = c(-5, 5), breaks=c(-5, -3, -1, 0, 1, 3, 5))
...
ggplot()+
  ...
  scale_color_manual(values = c("firebrick2", "gold1", "dodgerblue2"))+
  theme(legend.position = c("bottom"),legend.title = element_blank(), legend.text = element_text(colour = "black", size = 16), axis.text.x=element_text(size=16, colour="black"), axis.title.x=element_text(size=16),axis.text.y=element_text(size=16, colour="black"), axis.title.y=element_text(size=16), axis.line=element_line(color="black", size = 0.8), axis.ticks=element_line(color="black", size = 0.8))+
  labs( , y = "Odds ratio", title="Parkinsonism other disorders", x="Time before and after index date (years)")+
  scale_y_continuous(limits = c(0.5, 180), breaks=c(0.5, 1, seq(2, 180, by=20)))+   
  scale_x_continuous(limits = c(-5, 5), breaks=c(-5, -3, -1, 0, 1, 3, 5))
...
ggplot()+
  ...
  scale_color_manual(values = c("firebrick2", "gold1", "dodgerblue2"))+
  theme(legend.position = c("bottom"),legend.title = element_blank(), legend.text = element_text(colour = "black", size = 16), axis.text.x=element_text(size=16, colour="black"), axis.title.x=element_text(size=16),axis.text.y=element_text(size=16, colour="black"), axis.title.y=element_text(size=16), axis.line=element_line(color="black", size = 0.8), axis.ticks=element_line(color="black", size = 0.8))+
  labs( , y = "Odds ratio", title="Peripheral nerve disorders", x="Time before and after index date (years)")+
  scale_y_continuous(limits = c(0, 5), breaks=c(0.5, 1, seq(2, 5, by=1)))+   
  scale_x_continuous(limits = c(-5, 5), breaks=c(-5, -3, -1, 0, 1, 3, 5))
...
ggplot()+
  ...
  scale_color_manual(values = c("firebrick2", "gold1", "dodgerblue2"))+
  theme(legend.position = c("bottom"),legend.title = element_blank(), legend.text = element_text(colour = "black", size = 16), axis.text.x=element_text(size=16, colour="black"), axis.title.x=element_text(size=16),axis.text.y=element_text(size=16, colour="black"), axis.title.y=element_text(size=16), axis.line=element_line(color="black", size = 0.8), axis.ticks=element_line(color="black", size = 0.8))+
  labs( , y = "Odds ratio", title="Movement disorders, other")+
  scale_y_continuous(limits = c(0, 15), breaks=c(0.5, 1, seq(2, 15, by=1)))+   
  scale_x_continuous(limits = c(-5, 5), breaks=c(-5, -3, -1, 0, 1, 3, 5))
...
ggplot()+
  ...
  scale_color_manual(values = c("firebrick2", "gold1", "dodgerblue2"))+
  theme(legend.position = c("bottom"),legend.title = element_blank(), legend.text = element_text(colour = "black", size = 16), axis.text.x=element_text(size=16, colour="black"), axis.title.x=element_text(size=16),axis.text.y=element_text(size=16, colour="black"), axis.title.y=element_text(size=16), axis.line=element_line(color="black", size = 0.8), axis.ticks=element_line(color="black", size = 0.8))+
  labs( , y = "Odds ratio", title="Motor Neurone Disease")+
  scale_y_continuous(limits = c(0, 43), breaks=c(0.5, 1, seq(2, 43, by=4)))+   
  scale_x_continuous(limits = c(-5, 5), breaks=c(-5, -3, -1, 0, 1, 3, 5))
...
ggplot()+
  ...
  scale_color_manual(values = c("firebrick2", "gold1", "dodgerblue2"))+
  theme(legend.position = c("bottom"),legend.title = element_blank(), legend.text = element_text(colour = "black", size = 16), axis.text.x=element_text(size=16, colour="black"), axis.title.x=element_text(size=16),axis.text.y=element_text(size=16, colour="black"), axis.title.y=element_text(size=16), axis.line=element_line(color="black", size = 0.8), axis.ticks=element_line(color="black", size = 0.8))+
  labs( , y = "Odds ratio", title="Autonomic Nervous System Disorders")+
  scale_y_continuous(limits = c(0.5, 150), breaks=c(0.5, 1, seq(2, 150, by=10)))+   
  scale_x_continuous(limits = c(-5, 5), breaks=c(-5, -3, -1, 0, 1, 3, 5))
